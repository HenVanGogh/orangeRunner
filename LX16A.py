...
class LX16A:
    ...
    def __init__(self,Port="COM8",Baudrate=115200, Timeout= 0.001):
...
if __name__ == '__main__':
    ...
    while(1):
        ...
        while(1):
            sleep(2.0)
            m1.moveServo(12 , 321 , 1000)
            m1.moveServo(2 , 800 , 1000)
            sleep(2.0)
            m1.moveServo(12 , 521 , 1000)
            m1.moveServo(2 , 100 , 1000)
            
         
        
    sleep(2000.0)
        #
        #m1.moveServo(11 , 1000)
