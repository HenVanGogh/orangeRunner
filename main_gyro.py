...
if __name__ == '__main__':
    ...
    def keepSafe():
        ...
        pidX = PID(0.009, 0.16, 0.02, setpoint=0 , sample_time=0.005)
        pidZ = PID(0.009, 0.16, 0.02, setpoint=0 , sample_time=0.005)
        ...
        pidX.proportional_on_measurement = False
        pidZ.proportional_on_measurement = False
    ...
    keyboard.add_hotkey('Q', left_front)
